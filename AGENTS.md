...
- `ledger::Store` owns reading, validation, one-process exclusion and atomic file
  ...
  Task state, milestones and execution-scoped handoff checkpoints belong to the
  same file. Checkpoint updates require the live claim and matching revision;
  they do not change lifecycle, leases or official evidence.
